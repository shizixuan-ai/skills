...
- **[research-first](./research-first/SKILL.md)** — Search GitHub and package ecosystems for existing solutions before writing code, producing a structured buy-vs-build research report, and degrading gracefully into prototype or tdd when no suitable candidate exists.
